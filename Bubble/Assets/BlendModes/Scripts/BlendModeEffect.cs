...
namespace BlendModes
{
    ...
    public class BlendModeEffect : MonoBehaviour
    {
        ...
        /// <summary>
        /// Texture to blend with the object's texture in overlay render mode.
        /// </summary>
        public Texture OverlayTexture
        {
            get { return _overlayTexture; }
            set { _overlayTexture = value; SetupOverlay(); }
        }
    
        /// <summary>
        /// UV offset of the overlay texture used in overlay render mode.
        /// </summary>
        public Vector2 OverlayTextureOffset
        {
            get { return _overlayTextureOffset; }
            set { _overlayTextureOffset = value; SetupOverlay(); }
        }
    
        /// <summary>
        /// UV scale of the overlay texture used in overlay render mode.
        /// </summary>
        public Vector2 OverlayTextureScale
        {
            get { return _overlayTextureScale; }
            set { _overlayTextureScale = value; SetupOverlay(); }
        }
    
        /// <summary>
        /// Color to blend with the object in overlay render mode.
        /// </summary>
        public Color OverlayColor
        {
            get { return _overlayColor; }
            set { _overlayColor = value; SetupOverlay(); }
        }
        ...
        [SerializeField] private Texture _overlayTexture;
        [SerializeField] private Vector2 _overlayTextureOffset = Vector2.zero;
        [SerializeField] private Vector2 _overlayTextureScale = Vector2.one;
        [SerializeField] private Color _overlayColor = Color.white;
        [SerializeField] private MaskMode _maskMode = MaskMode.Disabled;
        [SerializeField] private MaskBehaviour _maskBehaviour = MaskBehaviour.Cutout;
        [SerializeField] private bool _enableAutoMask = false;
        ...
        {
            if (!Material || RenderMode != RenderMode.Overlay) return;
