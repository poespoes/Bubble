...
float2 GetGrabTexCoord(float4 screenPos)
{
    float2 grabTexCoord = screenPos.xy / screenPos.w;
    ...
    grabTexCoord = TransformStereoScreenSpaceTex(grabTexCoord, screenPos.w);
    #endif 
